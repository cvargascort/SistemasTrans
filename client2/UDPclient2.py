...
SERVER_RECEIVER_MESSAGE_PORT=5004
SERVER_SENDER_MESSAGE_PORT=5003
...
class Client():
    ...
    def send_file(self, filename):
        ...
        s.sendto(f"{filename}{SEPARATOR}{filesize}".encode(), (SERVER_HOST, SERVER_SENDER_PORT))
        ...
        with open(filename, "rb") as f:
            while True:
                ...
                s.sendall(bytes_read, (SERVER_HOST, SERVER_SENDER_PORT))
